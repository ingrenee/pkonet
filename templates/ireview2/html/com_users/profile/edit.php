...
?>
<div class="profile-edit <?php echo $this->pageclass_sfx?> profile-page">
...
<?php endforeach;?>
		...
		<div>
			<button type="submit" class="validate button submit-button"><span><?php echo JText::_('JSUBMIT'); ?></span></button>
