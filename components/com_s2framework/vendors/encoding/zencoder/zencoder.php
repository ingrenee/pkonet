...
function Services_Zencoder_autoload($className) {
	...
	// ClickFWD - modified path to allow it to work with symlinked folders
	
    return include realpath(str_replace('/administrator','',dirname($_SERVER["SCRIPT_FILENAME"]))) . "/components/com_s2framework/vendors/encoding/zencoder/$file.php";
