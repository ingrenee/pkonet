 ...
 * @subpackage	cake.cake.libs
 */
class S2Cache extends S2Object {
/**
 * Cache engine to use
 *
 * @var object
 ...
 * @subpackage	cake.cake.libs
 */
class CacheEngine extends S2Object {
 ...
 */
	function init($settings = array()) {
		$this->settings = array_merge(array('prefix' => 's2_', 'duration'=> 3600, 'probability'=> 100), $this->settings, $settings);
