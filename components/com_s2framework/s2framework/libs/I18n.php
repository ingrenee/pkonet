 ...
 * Included libraries.
 */
require(S2_LIBS . 'l10n.php');
require(S2_LIBS . 'set.php');
 ...
 * @access public
 */
	static function translate($singular, $plural = null, $domain = null, $category = null, $count = null) {
		...
		if (empty($_this->__domains)) {
			$_this->__domains = S2Cache::read($_this->domain,'_s2framework_core_');
		}
 ...
 */
	function __destruct() {
		if ($this->__cache) {
			S2Cache::write($this->domain, array_filter($this->__domains),'_s2framework_core_');
		}
	}
}
?>
