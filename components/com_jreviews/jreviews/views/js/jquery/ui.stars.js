...
$.widget('ui.stars', {
	...
	_create: function() {
		var self = this, o = this.options, starId = 0, naNum = 0; // naNum for counting N/A stars in JReviews ratings
		...
		this.$stars = this.$rboxs.map(function(i)
		{
			 ...
			 */			 
			if(o.split) { // contains changes for half point ratings in JReviews
				var oddeven = ((starId+naNum) % o.split);				
				if(o.id2val[i] != 'na') {
		...
		this.$stars.bind('click.stars', function(e) {
			...
			if (!o.disabled) {
				self.$value.removeAttr('disabled');
			}
