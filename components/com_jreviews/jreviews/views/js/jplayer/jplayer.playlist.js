...
(function($, undefined) {
	...
	jPlayerPlaylist.prototype = {
				...
				$.each(media, function(property,value) {
					...
					if(property === 'mp3') {
						...
						if($.jPlayer.prototype.format[property]) { // Check property is a media format.
							...
							listItem += "<a class='" + self.options.playlistOptions.freeItemClass + "' href='" + value + "' tabindex='1'>" + self.options.playlistOptions.downloadText + "</a>";
						}
					}
		...
		/* ClickFWD renamed to use the replacement method above */
		_createListItemBAK: function(media) {
			var self = this;
