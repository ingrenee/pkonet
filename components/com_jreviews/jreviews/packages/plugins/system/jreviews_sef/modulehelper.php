...
abstract class JModuleHelper
{
	...
	protected static function &_load()
	{
		...
		if (!($clean = $cache->get($cacheid)))
		{
			...
			// ClickFWD, added the m.published column
			$query->select('m.id, m.title, m.published, m.module, m.position, m.content, m.showtitle, m.params, mm.menuid');
			...
			// ClickFWD add the onPrepareModuleList trigger
			$app = JFactory::getApplication();
